...
uint256 hashGenesisBlock("0xf70574626f8c5fe5a3c8a948ca6ebed2c5cd8263e24753710e3e715b506a1f57");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // GMCoin: starting difficulty is 1 / 2^12
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // int64 nSubsidy = 1000000000000000;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbb7b0cb90e4e82ef827230c02bc0fdc0c0ad788a4e4e3393398d472d44715828");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "8/6/2018";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("071dbc8689169c5ee479984fb303b284d532921a3591b81615c401c1824c6cba61f9eb3c24a55d9d5fd3b4ae3789434bd1f1d7cc035792eba27d6a75b536fc1f81") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1533620021;
        block.nBits    = 504365644;
        block.nNonce   = 529019363;

        if (fTestNet)
        {
            block.nTime    = 1533620021;
            block.nNonce   = 3473993697;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x65bf77e567985f60cfec72f006428e58e843f81be789d1c2b944f149f0c7c3f9"));
        block.print();
