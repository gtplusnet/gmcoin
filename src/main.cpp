...
uint256 hashGenesisBlock("0x493f4ee918c3e493d029211faf9dce469ffbbf4bd29ff28693666bf4c783de94");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(536909973); // GMCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "GMCoin Signed Message:\n";
...
{
    // GMCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 10000000); // GMCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

//static const int64 nTargetTimespan = 302400; // GMCoin: 3.5 days
static const int64 nTargetTimespan = 1;
//static const int64 nTargetSpacing = 150; // GMCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // GMCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // GMCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // GMCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x1741f3c741260a649b8f1d92acd7e6735c083044de51cb6fd01b47807cb7f990");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "7/24/2018 GM Coin Created";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("a2c94d8ee7dbda3c2ed68e5f476701549799dd8538bb7cb11eb1ca47ca469bc617e8e13031567d374ab37d57b0b69d320dd691e73e38bb17b7cd067ed98ac8fab5") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1532414397;
        block.nBits    = 536909973;
        block.nNonce   = 1072424133;

        if (fTestNet)
        {
            block.nTime    = 1532414397;
            block.nNonce   = 2756442540;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xf8d9ec36e49795115ce91074a69a9ef2963ea4bcfded9cb23fe6d73727b110a7"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // GMCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("GMCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GMCoinMiner : ProcessBlock, block not accepted");
    }
